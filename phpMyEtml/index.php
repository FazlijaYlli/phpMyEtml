...
<body>
    ...
    <div class="container">
        <h1>Se connecter</h1>
<form method="post" action="<?php htmlspecialchars($_SERVER['PHP_SELF'])?>" enctype="multipart/form-data" name="form">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="radConnect" id="radConnect1" value="1" data-toggle="collapse" data-parent="#accordion"data-target=".collapseOne.show" >
